...
video_src_src_path = '/media/nk/HGST_SAS_8TB/AI/Dataset/hmdb51_org/'
img_dst_path= '/media/nk/HGST_SAS_8TB/AI/Dataset/hmdb_dtst/'
...
for i in label_name:
    ...
    video_save_path = os.path.join(img_dst_path, i) + '_jpg'
